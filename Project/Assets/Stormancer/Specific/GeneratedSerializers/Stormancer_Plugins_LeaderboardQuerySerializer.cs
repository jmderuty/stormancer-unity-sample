...
namespace GeneratedSerializers {
    ...
    public class Stormancer_Plugins_LeaderboardQuerySerializer : MsgPack.Serialization.MessagePackSerializer<Stormancer.Plugins.LeaderboardQuery> {
        ...
        private System.Action<Stormancer.Plugins.LeaderboardQuery, int> this_SetUnpackedValueOfCountDelegate;
        ...
        private System.Action<Stormancer.Plugins.LeaderboardQuery, string> this_SetUnpackedValueOfNameDelegate;
        ...
        public Stormancer_Plugins_LeaderboardQuerySerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            packOperationList[3] = new System.Action<MsgPack.Packer, Stormancer.Plugins.LeaderboardQuery>(this.PackValueOfCount);
            packOperationList[4] = new System.Action<MsgPack.Packer, Stormancer.Plugins.LeaderboardQuery>(this.PackValueOfSkip);
            packOperationList[5] = new System.Action<MsgPack.Packer, Stormancer.Plugins.LeaderboardQuery>(this.PackValueOfName);
            ...
            packOperationTable["Count"] = new System.Action<MsgPack.Packer, Stormancer.Plugins.LeaderboardQuery>(this.PackValueOfCount);
            packOperationTable["Skip"] = new System.Action<MsgPack.Packer, Stormancer.Plugins.LeaderboardQuery>(this.PackValueOfSkip);
            packOperationTable["Name"] = new System.Action<MsgPack.Packer, Stormancer.Plugins.LeaderboardQuery>(this.PackValueOfName);
            ...
            nullCheckerTable["Name"] = new System.Func<Stormancer.Plugins.LeaderboardQuery, bool>(this.IsNameNull);
            ...
            unpackOperationList[3] = new System.Action<MsgPack.Unpacker, Stormancer.Plugins.LeaderboardQuery, int, int>(this.UnpackValueOfCount);
            ...
            unpackOperationList[5] = new System.Action<MsgPack.Unpacker, Stormancer.Plugins.LeaderboardQuery, int, int>(this.UnpackValueOfName);
            ...
            unpackOperationTable["Count"] = new System.Action<MsgPack.Unpacker, Stormancer.Plugins.LeaderboardQuery, int, int>(this.UnpackValueOfCount);
            ...
            unpackOperationTable["Name"] = new System.Action<MsgPack.Unpacker, Stormancer.Plugins.LeaderboardQuery, int, int>(this.UnpackValueOfName);
            ...
            this.this_SetUnpackedValueOfCountDelegate = new System.Action<Stormancer.Plugins.LeaderboardQuery, int>(this.SetUnpackedValueOfCount);
            ...
            this.this_SetUnpackedValueOfNameDelegate = new System.Action<Stormancer.Plugins.LeaderboardQuery, string>(this.SetUnpackedValueOfName);
        ...
        private void PackValueOfCount(MsgPack.Packer packer, Stormancer.Plugins.LeaderboardQuery objectTree) {
            this._serializer3.PackTo(packer, objectTree.Count);
        }
        ...
        private void PackValueOfName(MsgPack.Packer packer, Stormancer.Plugins.LeaderboardQuery objectTree) {
            this._serializer0.PackTo(packer, objectTree.Name);
        }
        
        private bool IsNameNull(Stormancer.Plugins.LeaderboardQuery objectTree) {
        ...
        private void SetUnpackedValueOfCount(Stormancer.Plugins.LeaderboardQuery unpackingContext, int unpackedValue) {
            unpackingContext.Count = unpackedValue;
        }
        
        private void UnpackValueOfCount(MsgPack.Unpacker unpacker, Stormancer.Plugins.LeaderboardQuery unpackingContext, int indexOfItem, int itemsCount) {
            ...
            unpackHelperParameters2.MemberName = "Count";
            unpackHelperParameters2.DirectRead = this.MsgPack_Serialization_UnpackHelpers_UnpackInt32ValueDelegate;
            unpackHelperParameters2.Setter = this.this_SetUnpackedValueOfCountDelegate;
        ...
        private void SetUnpackedValueOfName(Stormancer.Plugins.LeaderboardQuery unpackingContext, string unpackedValue) {
            unpackingContext.Name = unpackedValue;
        }
        
        private void UnpackValueOfName(MsgPack.Unpacker unpacker, Stormancer.Plugins.LeaderboardQuery unpackingContext, int indexOfItem, int itemsCount) {
            ...
            unpackHelperParameters4.MemberName = "Name";
            ...
            unpackHelperParameters4.Setter = this.this_SetUnpackedValueOfNameDelegate;
