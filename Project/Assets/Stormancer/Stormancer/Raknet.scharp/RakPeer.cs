...
public class RakPeer : RakPeerInterface {
  ...
  public override StartupResult Startup(uint maxConnections, RakNetListSocketDescriptor socketDescriptors, int threadPriority) {
    StartupResult ret = (StartupResult)RakNetPINVOKE.RakPeer_Startup__SWIG_0(swigCPtr, maxConnections, RakNetListSocketDescriptor.getCPtr(socketDescriptors), threadPriority);
