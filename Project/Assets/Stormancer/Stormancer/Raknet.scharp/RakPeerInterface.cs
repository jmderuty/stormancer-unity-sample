...
public class RakPeerInterface : IDisposable {
  ...
  public virtual StartupResult Startup(uint maxConnections, RakNetListSocketDescriptor socketDescriptors) {
    StartupResult ret = (StartupResult)RakNetPINVOKE.RakPeerInterface_Startup__SWIG_1(swigCPtr, maxConnections, RakNetListSocketDescriptor.getCPtr(socketDescriptors));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
